...
import { ArrowRight, CheckCircle2, Cpu, Gauge, MapPin, Sparkles } from "lucide-react";
    ...
    <main>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {services.slice(0, 6).map((service) => {
              ...
              return (
                <article key={service.title} className="rounded border border-slate-200 bg-white p-6 shadow-sm">
                  <span className="mb-5 grid h-11 w-11 place-items-center rounded bg-graphite text-circuit">
                    <Icon size={22} />
                  </span>
                  <h3 className="text-lg font-bold text-graphite">{service.title}</h3>
      ...
      <section className="bg-graphite py-20 text-white">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 md:grid-cols-[0.95fr_1.05fr] lg:px-8">
          ...
          <div className="overflow-hidden rounded border border-white/14 bg-black">
            <Image
